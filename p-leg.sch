...
N 340 -290 360 -290 { lab=n_cal_ctrl[0]}
N 560 -290 580 -290 { lab=n_cal_ctrl[0]}
...
N 590 -450 690 -450 { lab=n_cal_ctrl[3:0]}
...
N 270 -290 340 -290 { lab=n_cal_ctrl[0]}
N 270 -240 560 -240 { lab=n_cal_ctrl[0]}
N 560 -290 560 -240 { lab=n_cal_ctrl[0]}
...
C {devices/bus_connect.sym} 260 -300 1 0 {name=l2 lab=n_cal_ctrl[0]}
C {devices/bus_connect.sym} 260 -350 1 0 {name=l8 lab=n_cal_ctrl[1]}
C {devices/bus_connect.sym} 260 -250 1 0 {name=l4 lab=n_cal_ctrl[0]}
