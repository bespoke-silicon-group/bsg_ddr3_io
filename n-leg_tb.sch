...
N 370 -220 370 -210 { lab=cal_ctrl[0]}
N 370 -150 370 -140 { lab=GND}
N 240 -220 240 -210 { lab=cal_ctrl[0]}
...
N 370 -280 370 -220 { lab=cal_ctrl[0]}
N 240 -280 240 -220 { lab=cal_ctrl[0]}
...
C {devices/bus_connect.sym} 230 -290 1 0 {name=l5 lab=cal_ctrl[0]}
C {devices/bus_connect.sym} 490 -290 1 0 {name=l6 lab=cal_ctrl[0]}
C {devices/bus_connect.sym} 360 -290 1 0 {name=l8 lab=cal_ctrl[0]}
