...
.include ./layout/pex_n-leg.spice
"
spice_ignore=false}
...
C {devices/lab_wire.sym} 480 -290 0 0 {name=l12 sig_type=std_logic_vector lab=cal_ctrl[0:3]}
C {schem/post_layout_n-leg.sym} 520 -230 0 0 {name=X1 GND=GND}
