...
N 140 -370 570 -370 { lab=n_cal_ctrl[0:3]
bus=true}
...
.include ./layout/pex_p-leg.spice
"
spice_ignore=false}
...
C {devices/lab_wire.sym} 350 -370 2 0 {name=l9 sig_type=std_logic lab=n_cal_ctrl[0:3]}
...
C {schem/post_layout_p-leg.sym} 550 -190 0 0 {name=X1 VDD=VDD}
